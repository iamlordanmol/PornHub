...
async def _(event):
    ...
    if splugin_name in borg._plugins:
        ...
        s_help_string = "****:"
    help_string = """@UniBorg ( **Custom Built By** @utkarshlord ) \n**Verified Account**: ✅\n**Official Website**: https://www.developerutkarsh.wordpress.com\n
Pithun {}
Talethrun {}
 
**Custom Built Fork**: https://github.com/iamlordutkarsh/PornHub""".format(
        sys.version,
        __version__
    )
